...
```{r ch01-fig-conceptual-model-a, out.width="1.1\\linewidth", fig.align = "center", fig.cap= "\\label{fig:conceptual-model-a}Example of a Conceptual Model (adapted from Fig. 15.1 in Greed, 2000)", echo=FALSE}
knitr::include_graphics(rep("figures/01-Figure-1a.png"))
```

```{r ch01-fig-conceptual-model-b, out.width="0.6\\linewidth", fig.align = "center", fig.cap= "\\label{fig:conceptual-model-b}Example of a Conceptual Model (adapted from Fig. 1.2 in Ortúzar and Willumsen, 2011)", echo=FALSE}
